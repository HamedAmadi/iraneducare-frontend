...
const Visa = async ({ params: { lng } }: { params: { lng: string; } }) => {
    ...
    const { t: tFIM } = await useTranslation(lng, 'feedback-and-improvement-mechanisms');
            ...
            <div className='relative w-full h-fit -z-10 bg-center bg-no-repeat bg-cover bg-[url("../../../public/images/world-map.png")]'>
                ...
                <div className="xs:container px-4">
                    <div className="pt-[clamp(6rem,16vw,10rem)] pb-[clamp(3rem,10vw,7rem)] text-center text-text">
                        <h1 className="text-[clamp(1.75rem,4vw,3rem)] font-BYekan">{tFIM('title')}</h1>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-12 md:gap-8">
                    ...
                    <div className="col-span-12 lg:col-span-8">
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tFIM('sub-title')}</h2>
                            <p className="md:text-lg text-[#335371] mb-4">{tFIM('introduction')}</p>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tFIM('whyCollectFeedback.title')}</h2>
                            <ul className="md:text-lg text-[#335371] space-y-4">
                                <li className="mb-4"><strong>{tFIM('whyCollectFeedback.point1-title')}</strong> - {tFIM('whyCollectFeedback.point1-desc')}</li>
                                <li className="mb-4"><strong>{tFIM('whyCollectFeedback.point2-title')}</strong> - {tFIM('whyCollectFeedback.point2-desc')}</li>
                                <li className="mb-4"><strong>{tFIM('whyCollectFeedback.point3-title')}</strong> - {tFIM('whyCollectFeedback.point3-desc')}</li>
                                <li className="mb-4"><strong>{tFIM('whyCollectFeedback.point4-title')}</strong> - {tFIM('whyCollectFeedback.point4-desc')}</li>
                            </ul>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tFIM('howWeCollectAndUseFeedback.title')}</h2>
                            <ul className="md:text-lg text-[#335371] space-y-4">
                                <li className="mb-4"><strong>{tFIM('howWeCollectAndUseFeedback.method1-title')}</strong> - {tFIM('howWeCollectAndUseFeedback.method1-desc')}</li>
                                <li className="mb-4"><strong>{tFIM('howWeCollectAndUseFeedback.method2-title')}</strong> - {tFIM('howWeCollectAndUseFeedback.method2-desc')}</li>
                                <li className="mb-4"><strong>{tFIM('howWeCollectAndUseFeedback.method3-title')}</strong> - {tFIM('howWeCollectAndUseFeedback.method3-desc')}</li>
                                <li className="mb-4"><strong>{tFIM('howWeCollectAndUseFeedback.method4-title')}</strong> - {tFIM('howWeCollectAndUseFeedback.method4-desc')}</li>
                                <li className="mb-4"><strong>{tFIM('howWeCollectAndUseFeedback.method5-title')}</strong> - {tFIM('howWeCollectAndUseFeedback.method5-desc')}</li>
                            </ul>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tFIM('stepsToProvideFeedback.title')}</h2>
                            <ul className="md:text-lg text-[#335371] space-y-4">
                                <li className="mb-4">
                                    <h3 className="text-lg md:text-xl mb-2"><strong>{tFIM('stepsToProvideFeedback.step1-title')}</strong></h3>
                                    <p>{tFIM('stepsToProvideFeedback.step1-desc')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-lg md:text-xl mb-2"><strong>{tFIM('stepsToProvideFeedback.step2-title')}</strong></h3>
                                    <p>{tFIM('stepsToProvideFeedback.step2-desc')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-lg md:text-xl mb-2"><strong>{tFIM('stepsToProvideFeedback.step3-title')}</strong></h3>
                                    <p>{tFIM('stepsToProvideFeedback.step3-desc')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-lg md:text-xl mb-2"><strong>{tFIM('stepsToProvideFeedback.step4-title')}</strong></h3>
                                    <p>{tFIM('stepsToProvideFeedback.step4-desc')}</p>
                                </li>
                            </ul>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tFIM('whyChooseOurSystem.title')}</h2>
                            <ul className="ps-8 list-disc md:text-lg text-[#335371] space-y-1">
                                <li><strong>{tFIM('whyChooseOurSystem.point1-title')}:</strong> {tFIM('whyChooseOurSystem.point1-desc')}</li>
                                <li><strong>{tFIM('whyChooseOurSystem.point2-title')}:</strong> {tFIM('whyChooseOurSystem.point2-desc')}</li>
                                <li><strong>{tFIM('whyChooseOurSystem.point3-title')}:</strong> {tFIM('whyChooseOurSystem.point3-desc')}</li>
                                <li><strong>{tFIM('whyChooseOurSystem.point4-title')}:</strong> {tFIM('whyChooseOurSystem.point4-desc')}</li>
                            </ul>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tFIM('faq.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tFIM('faq.q1')}</h3>
                                <p className="md:text-lg text-[#335371]">{tFIM('faq.a1')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tFIM('faq.q2')}</h3>
                                <p className="md:text-lg text-[#335371]">{tFIM('faq.a2')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tFIM('faq.q3')}</h3>
                                <p className="md:text-lg text-[#335371]">{tFIM('faq.a3')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tFIM('faq.q4')}</h3>
                                <p className="md:text-lg text-[#335371]">{tFIM('faq.a4')}</p>
                            </div>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tFIM('contact.title')}</h2>
                            <p className="md:text-lg text-[#335371]">{tFIM('contact.description')}</p>
                            {/* <div className="relative mt-12">
                                <Link href={`/${lng}/share-feedback`} className="relative px-[30px] py-[20px] lg:md:text-lg rounded-full bg-first text-white hover:text-text hover:bg-second">
