            ...
            <div className='relative w-full h-fit -z-10 bg-center bg-no-repeat bg-cover bg-[url("../../../public/images/world-map.png")]'>
                ...
                <div className="xs:container px-4">
                    <div className="pt-[clamp(6rem,16vw,10rem)] pb-[clamp(3rem,10vw,7rem)] text-center text-text">
                        <h1 className="text-[clamp(1.75rem,4vw,3rem)] font-BYekan">{tLA('title')}</h1>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-12 md:gap-8">
                    ...
                    <div className="col-span-12 lg:col-span-8">
                        ...
                        <section className="mb-8">
                            <h1 className="text-[clamp(1.25rem,4vw,1.875rem)] font-bold text-text mb-6">{tLA('sub-title')}</h1>
                            <p className="md:text-lg text-[#335371]">{tLA('introduction')}</p>
                        </section>

                        {/* خدمات ما */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tLA('services.title')}</h2>
                        ...
                        {/* مراحل دریافت خدمات */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tLA('howToApply.title')}</h2>
                        ...
                        {/* چرا ما؟ */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tLA('whyUs.title')}</h2>
                        ...
                        {/* سوالات متداول */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tLA('faq.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tLA('faq.q1')}</h3>
                                <p className="md:text-lg text-[#335371]">{tLA('faq.a1')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tLA('faq.q2')}</h3>
                                <p className="md:text-lg text-[#335371]">{tLA('faq.a2')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tLA('faq.q3')}</h3>
                                <p className="md:text-lg text-[#335371]">{tLA('faq.a3')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tLA('faq.q4')}</h3>
                                <p className="md:text-lg text-[#335371]">{tLA('faq.a4')}</p>
                            </div>
                        </section>

                        {/* بخش تماس */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tLA('contact.title')}</h2>
                            <p className="md:text-lg text-[#335371]">{tLA('contact.description')}</p>
