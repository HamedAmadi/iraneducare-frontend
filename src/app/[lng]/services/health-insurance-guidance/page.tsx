...
const Visa = async ({ params: { lng } }: { params: { lng: string; } }) => {
    ...
    const { t: tHIG } = await useTranslation(lng, 'health-insurance-guidance');
            ...
            <div className='relative w-full h-fit -z-10 bg-center bg-no-repeat bg-cover bg-[url("../../../public/images/world-map.png")]'>
                ...
                <div className="xs:container px-4">
                    <div className="pt-[clamp(6rem,16vw,10rem)] pb-[clamp(3rem,10vw,7rem)] text-center text-text">
                        <h1 className="text-[clamp(1.75rem,4vw,3rem)] font-BYekan">{tHIG('title')}</h1>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-12 md:gap-8">
                    ...
                    <div className="col-span-12 lg:col-span-8">
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tHIG('sub-title')}</h2>
                            {/* <p className="md:text-lg text-[#335371] mb-4">{tHIG('title')}</p> */}
                            <p className="md:text-lg text-[#335371] mb-4">{tHIG('introduction')}</p>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tHIG('whyInsurance.title')}</h2>
                            <ul className="md:text-lg text-[#335371] space-y-4">
                                <li className="mb-4"><strong>{tHIG('whyInsurance.point1-title')}</strong> - {tHIG('whyInsurance.point1-desc')}</li>
                                <li className="mb-4"><strong>{tHIG('whyInsurance.point2-title')}</strong> - {tHIG('whyInsurance.point2-desc')}</li>
                                <li className="mb-4"><strong>{tHIG('whyInsurance.point3-title')}</strong> - {tHIG('whyInsurance.point3-desc')}</li>
                                <li className="mb-4"><strong>{tHIG('whyInsurance.point4-title')}</strong> - {tHIG('whyInsurance.point4-desc')}</li>

                            </ul>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tHIG('insuranceTypes.title')}</h2>
                            <ul className="md:text-lg text-[#335371] space-y-4">
                                <li className="mb-4"><strong>{tHIG('insuranceTypes.type1-title')}</strong> - {tHIG('insuranceTypes.type1-desc')}</li>
                                <li className="mb-4"><strong>{tHIG('insuranceTypes.type2-title')}</strong> - {tHIG('insuranceTypes.type2-desc')}</li>
                                <li className="mb-4"><strong>{tHIG('insuranceTypes.type3-title')}</strong> - {tHIG('insuranceTypes.type3-desc')}</li>
                                <li className="mb-4"><strong>{tHIG('insuranceTypes.type4-title')}</strong> - {tHIG('insuranceTypes.type4-desc')}</li>
                            </ul>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tHIG('howToApply.title')}</h2>
                            <ul className="md:text-lg text-[#335371] space-y-4">
                                <li className="mb-4">
                                    <h3 className="text-lg md:text-xl mb-2"><strong>{tHIG('howToApply.step1-title')}</strong></h3>
                                    <p>{tHIG('howToApply.step1-desc')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-lg md:text-xl mb-2"><strong>{tHIG('howToApply.step2-title')}</strong></h3>
                                    <p>{tHIG('howToApply.step2-desc')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-lg md:text-xl mb-2"><strong>{tHIG('howToApply.step3-title')}</strong></h3>
                                    <p>{tHIG('howToApply.step3-desc')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-lg md:text-xl mb-2"><strong>{tHIG('howToApply.step4-title')}</strong></h3>
                                    <p>{tHIG('howToApply.step4-desc')}</p>
                                </li>
                            </ul>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tHIG('whyUs.title')}</h2>
                            <ul className="ps-8 list-disc md:text-lg text-[#335371] space-y-1">
                                <li><strong>{tHIG('whyUs.point1-title')}:</strong> {tHIG('whyUs.point1-desc')}</li>
                                <li><strong>{tHIG('whyUs.point2-title')}:</strong> {tHIG('whyUs.point2-desc')}</li>
                                <li><strong>{tHIG('whyUs.point3-title')}:</strong> {tHIG('whyUs.point3-desc')}</li>
                                <li><strong>{tHIG('whyUs.point4-title')}:</strong> {tHIG('whyUs.point4-desc')}</li>
                            </ul>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tHIG('faq.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tHIG('faq.q1')}</h3>
                                <p className="md:text-lg text-[#335371]">{tHIG('faq.a1')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tHIG('faq.q2')}</h3>
                                <p className="md:text-lg text-[#335371]">{tHIG('faq.a2')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tHIG('faq.q3')}</h3>
                                <p className="md:text-lg text-[#335371]">{tHIG('faq.a3')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tHIG('faq.q4')}</h3>
                                <p className="md:text-lg text-[#335371]">{tHIG('faq.a4')}</p>
                            </div>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tHIG('contact.title')}</h2>
                            <p className="md:text-lg text-[#335371]">{tHIG('contact.description')}</p>
