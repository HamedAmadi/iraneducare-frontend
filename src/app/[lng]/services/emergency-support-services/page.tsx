            ...
            <div className='relative w-full h-fit -z-10 bg-center bg-no-repeat bg-cover bg-[url("../../../public/images/world-map.png")]'>
                ...
                <div className="container">
                    <div className="pt-40 pb-28 text-center text-text">
                        <h1 className="text-5xl mb-5 font-BYekan">{tESS('title')}</h1>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-12 gap-8">
                    ...
                    <div className="col-span-12 lg:col-span-8">
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tESS('sub-title')}</h2>
                            {/* <h3 className="text-2xl text-text mb-6">{tESS('sub-title')}</h3> */}
                            <p className="text-lg text-[#335371] mb-4">{tESS('introduction')}</p>
                        </section>

                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tESS('whyEmergencySupport.title')}</h2>
                        ...
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tESS('services.title')}</h2>
                            <ul className="text-lg text-[#335371] space-y-4">
                        ...
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tESS('howToApply.title')}</h2>
                            <ul className="text-lg text-[#335371] space-y-4">
                                <li className="mb-4">
                                    <h3 className="text-xl mb-2"><strong>{tESS('howToApply.step1-title')}</strong></h3>
                                    <p>{tESS('howToApply.step1-desc')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-xl mb-2"><strong>{tESS('howToApply.step2-title')}</strong></h3>
                                    <p>{tESS('howToApply.step2-desc')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-xl mb-2"><strong>{tESS('howToApply.step3-title')}</strong></h3>
                                    <p>{tESS('howToApply.step3-desc')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-xl mb-2"><strong>{tESS('howToApply.step4-title')}</strong></h3>
                        ...
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tESS('whyUs.title')}</h2>
                        ...
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tESS('faq.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tESS('faq.q1')}</h3>
                                <p className="text-lg text-[#335371]">{tESS('faq.a1')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tESS('faq.q2')}</h3>
                                <p className="text-lg text-[#335371]">{tESS('faq.a2')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tESS('faq.q3')}</h3>
                                <p className="text-lg text-[#335371]">{tESS('faq.a3')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tESS('faq.q4')}</h3>
                                <p className="text-lg text-[#335371]">{tESS('faq.a4')}</p>
                            </div>
                        </section>

                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tESS('contact.title')}</h2>
                            <p className="text-lg text-[#335371]">{tESS('contact.description')}</p>
                            {/* <div className="relative mt-12">
                                <Link href={`/${lng}/get-emergency-assistance`} className="relative px-[30px] py-[20px] lg:text-lg rounded-full bg-first text-white hover:text-text hover:bg-second">
                                    {tESS('contact.button')}
                                </Link>
                            </div> */}
                        </section>
