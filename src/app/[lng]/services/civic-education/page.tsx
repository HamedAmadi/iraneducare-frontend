            ...
            <div className='relative w-full h-fit -z-10 bg-center bg-no-repeat bg-cover bg-[url("../../../public/images/world-map.png")]'>
                ...
                <div className="container">
                    <div className="pt-40 pb-28 text-center text-text">
                        <h1 className="text-5xl mb-5 font-BYekan">{tCE('title')}</h1>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-12 gap-8">
                    ...
                    <div className="col-span-12 lg:col-span-8">
                        ...
                        <section className="mb-16">
                            <h1 className="text-3xl font-bold text-text mb-6">{tCE('sub-title')}</h1>
                            <p className="text-lg text-[#335371]">{tCE('introduction')}</p>
                        </section>

                        {/* موضوعات التدريب */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tCE('trainingTopics.title')}</h2>
                        ...
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tCE('howToJoin.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tCE('howToJoin.step1-title')}</h3>
                                <p className="text-lg text-[#335371]">{tCE('howToJoin.step1-desc')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tCE('howToJoin.step2-title')}</h3>
                                <p className="text-lg text-[#335371]">{tCE('howToJoin.step2-desc')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tCE('howToJoin.step3-title')}</h3>
                                <p className="text-lg text-[#335371]">{tCE('howToJoin.step3-desc')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tCE('howToJoin.step4-title')}</h3>
                                <p className="text-lg text-[#335371]">{tCE('howToJoin.step4-desc')}</p>
                            </div>
                        ...
                        {/* لماذا نحن؟ */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tCE('whyUs.title')}</h2>
                            <ul className="ps-8 list-disc text-lg text-[#335371] space-y-1">
                        ...
                        {/* بخش سوالات متداول */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tCE('faq.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tCE('faq.q1')}</h3>
                                <p className="text-lg text-[#335371]">{tCE('faq.a1')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tCE('faq.q2')}</h3>
                                <p className="text-lg text-[#335371]">{tCE('faq.a2')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tCE('faq.q3')}</h3>
                                <p className="text-lg text-[#335371]">{tCE('faq.a3')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tCE('faq.q4')}</h3>
                                <p className="text-lg text-[#335371]">{tCE('faq.a4')}</p>
                            </div>
                        </section>

                        {/* حجز الدورة */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tCE('contact.title')}</h2>
                            <p className="text-lg text-[#335371]">{tCE('contact.description')}</p>
