...
const CivicEducation = async ({ params: { lng } }: { params: { lng: string; } }) => {
    ...
    const { t: tCE } = await useTranslation(lng, 'civic-education');
            ...
            <div className='relative w-full h-fit -z-10 bg-center bg-no-repeat bg-cover bg-[url("../../../public/images/world-map.png")]'>
                ...
                <div className="xs:container px-4">
                    <div className="pt-[clamp(6rem,16vw,10rem)] pb-[clamp(3rem,10vw,7rem)] text-center text-text">
                        <h1 className="text-[clamp(1.75rem,4vw,3rem)] font-BYekan">{tCE('title')}</h1>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-12 md:gap-8">
                    ...
                    <div className="col-span-12 lg:col-span-8">
                        ...
                        <section className="mb-8">
                            <h1 className="text-[clamp(1.25rem,4vw,1.875rem)] font-bold text-text mb-6">{tCE('sub-title')}</h1>
                            <p className="md:text-lg text-[#335371]">{tCE('introduction')}</p>
                        </section>

                        {/* موضوعات التدريب */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tCE('trainingTopics.title')}</h2>
                            <ul className="ps-8 list-disc md:text-lg text-[#335371] space-y-1">
                                <li><strong>{tCE('trainingTopics.topic1-title')}</strong> - {tCE('trainingTopics.topic1-desc')}</li>
                                <li><strong>{tCE('trainingTopics.topic2-title')}</strong> - {tCE('trainingTopics.topic2-desc')}</li>
                                <li><strong>{tCE('trainingTopics.topic3-title')}</strong> - {tCE('trainingTopics.topic3-desc')}</li>
                                <li><strong>{tCE('trainingTopics.topic4-title')}</strong> - {tCE('trainingTopics.topic4-desc')}</li>
                                <li><strong>{tCE('trainingTopics.topic5-title')}</strong> - {tCE('trainingTopics.topic5-desc')}</li>
                                <li><strong>{tCE('trainingTopics.topic6-title')}</strong> - {tCE('trainingTopics.topic6-desc')}</li>
                            </ul>
                        </section>

                        {/* كيفية الانضمام إلى البرنامج */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tCE('howToJoin.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tCE('howToJoin.step1-title')}</h3>
                                <p className="md:text-lg text-[#335371]">{tCE('howToJoin.step1-desc')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tCE('howToJoin.step2-title')}</h3>
                                <p className="md:text-lg text-[#335371]">{tCE('howToJoin.step2-desc')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tCE('howToJoin.step3-title')}</h3>
                                <p className="md:text-lg text-[#335371]">{tCE('howToJoin.step3-desc')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tCE('howToJoin.step4-title')}</h3>
                                <p className="md:text-lg text-[#335371]">{tCE('howToJoin.step4-desc')}</p>
                            </div>
                        ...
                        {/* لماذا نحن؟ */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tCE('whyUs.title')}</h2>
                            <ul className="ps-8 list-disc md:text-lg text-[#335371] space-y-1">
                                <li>{tCE('whyUs.point1')}</li>
                                <li>{tCE('whyUs.point2')}</li>
                                <li>{tCE('whyUs.point3')}</li>
                                <li>{tCE('whyUs.point4')}</li>
                            </ul>
                        </section>

                        {/* بخش سوالات متداول */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tCE('faq.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tCE('faq.q1')}</h3>
                                <p className="md:text-lg text-[#335371]">{tCE('faq.a1')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tCE('faq.q2')}</h3>
                                <p className="md:text-lg text-[#335371]">{tCE('faq.a2')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tCE('faq.q3')}</h3>
                                <p className="md:text-lg text-[#335371]">{tCE('faq.a3')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tCE('faq.q4')}</h3>
                                <p className="md:text-lg text-[#335371]">{tCE('faq.a4')}</p>
                            </div>
                        </section>

                        {/* حجز الدورة */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tCE('contact.title')}</h2>
                            <p className="md:text-lg text-[#335371]">{tCE('contact.description')}</p>
