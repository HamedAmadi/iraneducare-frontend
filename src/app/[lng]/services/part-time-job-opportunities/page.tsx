            ...
            <div className='relative w-full h-fit -z-10 bg-center bg-no-repeat bg-cover bg-[url("../../../public/images/world-map.png")]'>
                ...
                <div className="xs:container px-4">
                    <div className="pt-[clamp(6rem,16vw,10rem)] pb-[clamp(3rem,10vw,7rem)] text-center text-text">
                        <h1 className="text-[clamp(1.75rem,4vw,3rem)] font-BYekan">{tPTJO('title')}</h1>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-12 md:gap-8">
                    ...
                    <div className="col-span-12 lg:col-span-8">
                        ...
                        <section className="mb-8">
                            <h1 className="text-[clamp(1.25rem,4vw,1.875rem)] font-bold text-text mb-6">{tPTJO('sub-title')}</h1>
                            <p className="md:text-lg text-[#335371]">{tPTJO('introduction')}</p>
                        </section>

                        {/* مزایای کار پاره‌وقت */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tPTJO('benefits.title')}</h2>
                        ...
                        {/* انواع فرصت‌های شغلی */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tPTJO('jobTypes.title')}</h2>
                            <ul className="ps-8 list-disc md:text-lg text-[#335371] space-y-4">
                        ...
                        {/* مراحل دریافت شغل */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tPTJO('howToApply.title')}</h2>
                        ...
                        {/* چرا خدمات ما؟ */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tPTJO('whyUs.title')}</h2>
                        ...
                        {/* سوالات متداول */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tPTJO('faq.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tPTJO('faq.q1')}</h3>
                                <p className="md:text-lg text-[#335371]">{tPTJO('faq.a1')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tPTJO('faq.q2')}</h3>
                                <p className="md:text-lg text-[#335371]">{tPTJO('faq.a2')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tPTJO('faq.q3')}</h3>
                                <p className="md:text-lg text-[#335371]">{tPTJO('faq.a3')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tPTJO('faq.q4')}</h3>
                                <p className="md:text-lg text-[#335371]">{tPTJO('faq.a4')}</p>
                            </div>
                        </section>

                        {/* بخش تماس */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tPTJO('contact.title')}</h2>
                            <p className="md:text-lg text-[#335371]">{tPTJO('contact.description')}</p>
