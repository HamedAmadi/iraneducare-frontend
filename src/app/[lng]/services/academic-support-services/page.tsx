...
const Visa = async ({ params: { lng } }: { params: { lng: string; } }) => {
    ...
    const { t: tASS } = await useTranslation(lng, 'academic-support-services');
            ...
            <div className='relative w-full h-fit -z-10 bg-center bg-no-repeat bg-cover bg-[url("../../../public/images/world-map.png")]'>
                ...
                <div className="xs:container px-4">
                    <div className="pt-[clamp(6rem,16vw,10rem)] pb-[clamp(3rem,10vw,7rem)] text-center text-text">
                        <h1 className="text-[clamp(1.75rem,4vw,3rem)] font-BYekan">{tASS('title')}</h1>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-12 md:gap-8">
                    ...
                    <div className="col-span-12 lg:col-span-8">
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tASS('sub-title')}</h2>
                            <p className="md:text-lg text-[#335371] mb-4">{tASS('introduction')}</p>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tASS('whySupport.title')}</h2>
                            <ul className="md:text-lg text-[#335371] space-y-4">
                                <li className="mb-4"><strong>{tASS('whySupport.point1-title')}</strong> - {tASS('whySupport.point1-desc')}</li>
                                <li className="mb-4"><strong>{tASS('whySupport.point2-title')}</strong> - {tASS('whySupport.point2-desc')}</li>
                                <li className="mb-4"><strong>{tASS('whySupport.point3-title')}</strong> - {tASS('whySupport.point3-desc')}</li>
                                <li className="mb-4"><strong>{tASS('whySupport.point4-title')}</strong> - {tASS('whySupport.point4-desc')}</li>
                            </ul>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tASS('services.title')}</h2>
                            <ul className="md:text-lg text-[#335371] space-y-4">
                                <li className="mb-4"><strong>{tASS('services.service1-title')}</strong> - {tASS('services.service1-desc')}</li>
                                <li className="mb-4"><strong>{tASS('services.service2-title')}</strong> - {tASS('services.service2-desc')}</li>
                                <li className="mb-4"><strong>{tASS('services.service3-title')}</strong> - {tASS('services.service3-desc')}</li>
                                <li className="mb-4"><strong>{tASS('services.service4-title')}</strong> - {tASS('services.service4-desc')}</li>
                                <li className="mb-4"><strong>{tASS('services.service5-title')}</strong> - {tASS('services.service5-desc')}</li>
                            </ul>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tASS('howToApply.title')}</h2>
                            <ul className="md:text-lg text-[#335371] space-y-4">
                                <li className="mb-4">
                                    <h3 className="text-lg md:text-xl mb-2"><strong>{tASS('howToApply.step1-title')}</strong></h3>
                                    <p>{tASS('howToApply.step1-desc')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-lg md:text-xl mb-2"><strong>{tASS('howToApply.step2-title')}</strong></h3>
                                    <p>{tASS('howToApply.step2-desc')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-lg md:text-xl mb-2"><strong>{tASS('howToApply.step3-title')}</strong></h3>
                                    <p>{tASS('howToApply.step3-desc')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-lg md:text-xl mb-2"><strong>{tASS('howToApply.step4-title')}</strong></h3>
                                    <p>{tASS('howToApply.step4-desc')}</p>
                                </li>
                            </ul>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tASS('whyUs.title')}</h2>
                            <ul className="ps-8 list-disc md:text-lg text-[#335371] space-y-1">
                                <li><strong>{tASS('whyUs.point1-title')}:</strong> {tASS('whyUs.point1-desc')}</li>
                                <li><strong>{tASS('whyUs.point2-title')}:</strong> {tASS('whyUs.point2-desc')}</li>
                                <li><strong>{tASS('whyUs.point3-title')}:</strong> {tASS('whyUs.point3-desc')}</li>
                                <li><strong>{tASS('whyUs.point4-title')}:</strong> {tASS('whyUs.point4-desc')}</li>
                            </ul>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tASS('faq.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tASS('faq.q1')}</h3>
                                <p className="md:text-lg text-[#335371]">{tASS('faq.a1')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tASS('faq.q2')}</h3>
                                <p className="md:text-lg text-[#335371]">{tASS('faq.a2')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tASS('faq.q3')}</h3>
                                <p className="md:text-lg text-[#335371]">{tASS('faq.a3')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tASS('faq.q4')}</h3>
                                <p className="md:text-lg text-[#335371]">{tASS('faq.a4')}</p>
                            </div>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tASS('contact.title')}</h2>
                            <p className="md:text-lg text-[#335371]">{tASS('contact.description')}</p>
                            {/* <div className="relative mt-12">
                                <Link href={`/${lng}/request-academic-assistance`} className="relative px-[30px] py-[20px] lg:md:text-lg rounded-full bg-first text-white hover:text-text hover:bg-second">
                                    {tASS('contact.button')}
                                </Link>
                            </div> */}
                        </section>
