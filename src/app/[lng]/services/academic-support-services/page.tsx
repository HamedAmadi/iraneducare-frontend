            ...
            <div className='relative w-full h-fit -z-10 bg-center bg-no-repeat bg-cover bg-[url("../../../public/images/world-map.png")]'>
                ...
                <div className="container">
                    <div className="pt-40 pb-28 text-center text-text">
                        <h1 className="text-5xl mb-5 font-BYekan">{tASS('title')}</h1>
                    </div>
                </div>
            </div>
            <div className="container py-16">
                <div className="grid grid-cols-12 gap-8">
                    ...
                    <div className="col-span-12 lg:col-span-8">
                        ...
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tASS('whySupport.title')}</h2>
                        ...
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tASS('services.title')}</h2>
                            <ul className="text-lg text-[#335371] space-y-4">
                        ...
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tASS('howToApply.title')}</h2>
                            <ul className="text-lg text-[#335371] space-y-4">
                                <li className="mb-4">
                                    <h3 className="text-xl mb-2"><strong>{tASS('howToApply.step1-title')}</strong></h3>
                                    <p>{tASS('howToApply.step1-desc')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-xl mb-2"><strong>{tASS('howToApply.step2-title')}</strong></h3>
                                    <p>{tASS('howToApply.step2-desc')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-xl mb-2"><strong>{tASS('howToApply.step3-title')}</strong></h3>
                                    <p>{tASS('howToApply.step3-desc')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-xl mb-2"><strong>{tASS('howToApply.step4-title')}</strong></h3>
                        ...
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tASS('whyUs.title')}</h2>
                        ...
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tASS('faq.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tASS('faq.q1')}</h3>
                                <p className="text-lg text-[#335371]">{tASS('faq.a1')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tASS('faq.q2')}</h3>
                                <p className="text-lg text-[#335371]">{tASS('faq.a2')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tASS('faq.q3')}</h3>
                                <p className="text-lg text-[#335371]">{tASS('faq.a3')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tASS('faq.q4')}</h3>
                                <p className="text-lg text-[#335371]">{tASS('faq.a4')}</p>
                            </div>
                        </section>

                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tASS('contact.title')}</h2>
                            <p className="text-lg text-[#335371]">{tASS('contact.description')}</p>
                            {/* <div className="relative mt-12">
                                <Link href={`/${lng}/request-academic-assistance`} className="relative px-[30px] py-[20px] lg:text-lg rounded-full bg-first text-white hover:text-text hover:bg-second">
                                    {tASS('contact.button')}
                                </Link>
                            </div> */}
                        </section>
