            ...
            <div className='relative w-full h-fit -z-10 bg-center bg-no-repeat bg-cover bg-[url("../../../public/images/world-map.png")]'>
                ...
                <div className="xs:container px-4">
                    <div className="pt-[clamp(6rem,16vw,10rem)] pb-[clamp(3rem,10vw,7rem)] text-center text-text">
                        <h1 className="text-[clamp(1.75rem,4vw,3rem)] font-BYekan">{tSNE('title')}</h1>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-12 md:gap-8">
                    ...
                    <div className="col-span-12 lg:col-span-8">
                        <section className="mb-8">
                            <h1 className="text-[clamp(1.25rem,4vw,1.875rem)] font-bold text-text mb-6">{tSNE('sub-title')}</h1>
                            <p className="md:text-lg text-[#335371]">{tSNE('introduction')}</p>
                        </section>

                        {/* چرا شرکت در این برنامه؟ */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tSNE('whyParticipate.title')}</h2>
                        ...
                        {/* انواع رویدادها */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tSNE('eventTypes.title')}</h2>
                            <ul className="ps-8 list-disc md:text-lg text-[#335371] space-y-1">
                        ...
                        {/* چگونه شرکت کنیم؟ */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tSNE('howToJoin.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tSNE('howToJoin.step1-title')}</h3>
                                <p className="md:text-lg text-[#335371]">{tSNE('howToJoin.step1-desc')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tSNE('howToJoin.step2-title')}</h3>
                                <p className="md:text-lg text-[#335371]">{tSNE('howToJoin.step2-desc')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tSNE('howToJoin.step3-title')}</h3>
                                <p className="md:text-lg text-[#335371]">{tSNE('howToJoin.step3-desc')}</p>
                            </div>
                        </section>

                        {/* چرا ما؟ */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tSNE('whyUs.title')}</h2>
                            <ul className="ps-8 list-disc md:text-lg text-[#335371] space-y-1">
                        ...
                        {/* سوالات متداول */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tSNE('faq.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tSNE('faq.q1')}</h3>
                                <p className="md:text-lg text-[#335371]">{tSNE('faq.a1')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tSNE('faq.q2')}</h3>
                                <p className="md:text-lg text-[#335371]">{tSNE('faq.a2')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tSNE('faq.q3')}</h3>
                                <p className="md:text-lg text-[#335371]">{tSNE('faq.a3')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tSNE('faq.q4')}</h3>
                                <p className="md:text-lg text-[#335371]">{tSNE('faq.a4')}</p>
                            </div>
                        </section>

                        {/* تماس و ثبت‌نام */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tSNE('contact.title')}</h2>
                            <p className="md:text-lg text-[#335371]">{tSNE('contact.description')}</p>
