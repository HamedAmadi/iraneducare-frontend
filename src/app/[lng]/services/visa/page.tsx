...
const Visa = async ({ params: { lng } }: { params: { lng: string; } }) => {
    ...
    const { t: tV } = await useTranslation(lng, 'visa');
            ...
            <div className='relative w-full h-fit -z-10 bg-center bg-no-repeat bg-cover bg-[url("../../../public/images/world-map.png")]'>
                ...
                <div className="xs:container px-4">
                    <div className="pt-[clamp(6rem,16vw,10rem)] pb-[clamp(3rem,10vw,7rem)] text-center text-text">
                        <h1 className="text-[clamp(1.75rem,4vw,3rem)] mb-2 md:mb-5 font-BYekan">{tV('title')}</h1>
                        <h2 className="text-[clamp(1.5rem,4vw,1.875rem)] font-BYekan">{tV('sub-title')}</h2>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-12 md:gap-8">
                    ...
                    <div className="col-span-12 lg:col-span-8">
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tV('visaProcess.title')}</h2>
                            <p className="md:text-lg text-[#335371] mb-4">{tV('visaProcess.desc')}</p>
                            <ul className="md:text-lg text-[#335371] space-y-4">
                                <li className="mb-4">
                                    <h3 className="text-lg md:text-xl mb-2"><strong>{tV('visaProcess.step1.title')}</strong></h3>
                                    <p>{tV('visaProcess.step1.description')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-lg md:text-xl mb-2"><strong>{tV('visaProcess.step2.title')}</strong></h3>
                                    <ul className="ps-8 list-disc space-y-1">
                                        <li>{tV('visaProcess.step2.point1')}</li>
                                        <li>{tV('visaProcess.step2.point2')}</li>
                                        <li>{tV('visaProcess.step2.point3')}</li>
                                        <li>{tV('visaProcess.step2.point4')}</li>
                                        <li>{tV('visaProcess.step2.point5')}</li>
                                        <li>{tV('visaProcess.step2.point6')}</li>
                                    </ul>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-lg md:text-xl mb-2"><strong>{tV('visaProcess.step3.title')}</strong></h3>
                                    <p>{tV('visaProcess.step3.description')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-lg md:text-xl mb-2"><strong>{tV('visaProcess.step4.title')}</strong></h3>
                                    <ul className="ps-8 list-disc space-y-1">
                                        <li>{tV('visaProcess.step4.point1')}</li>
                                        <li>{tV('visaProcess.step4.point2')}</li>
                                    </ul>
                                </li>
                            </ul>
                        </section>
                        ...
                        {/* بخش چرا ما؟ */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tV('whyUs.title')}</h2>
                            <ul className="ps-8 list-disc md:text-lg text-[#335371] space-y-1">
                                <li><strong>{tV('whyUs.point1-title')}</strong> {tV('whyUs.point1-desc')}</li>
                                <li><strong>{tV('whyUs.point2-title')}</strong> {tV('whyUs.point2-desc')}</li>
                                <li><strong>{tV('whyUs.point3-title')}</strong> {tV('whyUs.point3-desc')}</li>
                                <li><strong>{tV('whyUs.point4-title')}</strong> {tV('whyUs.point4-desc')}</li>
                            </ul>
                        </section>

                        {/* بخش سوالات متداول */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tV('faq.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tV('faq.q1')}</h3>
                                <p className="md:text-lg text-[#335371]">{tV('faq.a1')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tV('faq.q2')}</h3>
                                <p className="md:text-lg text-[#335371]">{tV('faq.a2')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tV('faq.q3')}</h3>
                                <p className="md:text-lg text-[#335371]">{tV('faq.a3')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-lg md:text-xl text-[#335371] mb-1">{tV('faq.q4')}</h3>
                                <p className="md:text-lg text-[#335371]">{tV('faq.a4')}</p>
                            </div>
                        </section>

                        {/* بخش تماس */}
                        <section className="mb-8">
                            <h2 className="text-[clamp(1.25rem,4vw,1.875rem)] text-text font-bold mb-6">{tV('contact.title')}</h2>
                            <p className="md:text-lg text-[#335371]">{tV('contact.description')}</p>
