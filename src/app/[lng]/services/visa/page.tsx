            ...
            <div className='relative w-full h-fit -z-10 bg-center bg-no-repeat bg-cover bg-[url("../../../public/images/world-map.png")]'>
                ...
                <div className="container">
                    <div className="pt-40 pb-28 text-center text-text">
                        <h1 className="text-5xl mb-5 font-BYekan">{tV('title')}</h1>
                        <h2 className="text-3xl font-BYekan">{tV('sub-title')}</h2>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-12 gap-8">
                    ...
                    <div className="col-span-12 lg:col-span-8">
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tV('visaProcess.title')}</h2>
                            <p className="text-lg text-[#335371] mb-4">{tV('visaProcess.desc')}</p>
                            <ul className="text-lg text-[#335371] space-y-4">
                                <li className="mb-4">
                                    <h3 className="text-xl mb-2"><strong>{tV('visaProcess.step1.title')}</strong></h3>
                                    <p>{tV('visaProcess.step1.description')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-xl mb-2"><strong>{tV('visaProcess.step2.title')}</strong></h3>
                                ...
                                <li className="mb-4">
                                    <h3 className="text-xl mb-2"><strong>{tV('visaProcess.step3.title')}</strong></h3>
                                    <p>{tV('visaProcess.step3.description')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-xl mb-2"><strong>{tV('visaProcess.step4.title')}</strong></h3>
                                    <ul className="ps-8 list-disc space-y-1">
                        ...
                        {/* بخش چرا ما؟ */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tV('whyUs.title')}</h2>
                        ...
                        {/* بخش سوالات متداول */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tV('faq.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tV('faq.q1')}</h3>
                                <p className="text-lg text-[#335371]">{tV('faq.a1')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tV('faq.q2')}</h3>
                                <p className="text-lg text-[#335371]">{tV('faq.a2')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tV('faq.q3')}</h3>
                                <p className="text-lg text-[#335371]">{tV('faq.a3')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tV('faq.q4')}</h3>
                                <p className="text-lg text-[#335371]">{tV('faq.a4')}</p>
                            </div>
                        </section>

                        {/* بخش تماس */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tV('contact.title')}</h2>
                            <p className="text-lg text-[#335371]">{tV('contact.description')}</p>
