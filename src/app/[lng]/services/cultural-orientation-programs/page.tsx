            ...
            <div className='relative w-full h-fit -z-10 bg-center bg-no-repeat bg-cover bg-[url("../../../public/images/world-map.png")]'>
                ...
                <div className="container">
                    <div className="pt-40 pb-28 text-center text-text">
                        <h1 className="text-5xl mb-5 font-BYekan">{tCOP('culturalOrientation.title')}</h1>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-12 gap-8">
                    ...
                    <div className="col-span-12 lg:col-span-8">
                        ...
                        <section className="mb-16">
                            <h1 className="text-2xl font-bold text-text mb-6">{tCOP('culturalOrientation.subtitle')}</h1>
                            <p className="text-lg text-[#335371]">{tCOP('culturalOrientation.description')}</p>
                        </section>

                        {/* چرا آشنایی با فرهنگ ایران مهم است؟ */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tCOP('whyCulturalOrientation.title')}</h2>
                        ...
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tCOP('programCoverage.title')}</h2>
                            <ul className="ps-8 list-disc text-lg text-[#335371] space-y-4">
                        ...
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tCOP('participationSteps.title')}</h2>
                        ...
                        {/* چرا برنامه‌های ما؟ */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tCOP('whyJoin.title')}</h2>
                        ...
                        {/* سوالات متداول */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tCOP('faq.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tCOP('faq.q1')}</h3>
                                <p className="text-lg text-[#335371]">{tCOP('faq.a1')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tCOP('faq.q2')}</h3>
                                <p className="text-lg text-[#335371]">{tCOP('faq.a2')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tCOP('faq.q3')}</h3>
                                <p className="text-lg text-[#335371]">{tCOP('faq.a3')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tCOP('faq.q4')}</h3>
                                <p className="text-lg text-[#335371]">{tCOP('faq.a4')}</p>
                            </div>
                        </section>

                        {/* بخش تماس */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tCOP('contact.title')}</h2>
                            <p className="text-lg text-[#335371]">{tCOP('contact.description')}</p>
                            {/* <div className="relative mt-12">
                                <a href="/contact" className="relative px-[30px] py-[20px] lg:text-lg rounded-full bg-first text-white hover:text-text hover:bg-second">
                                    {tCOP('contact.button')}
                                </a>
                            </div> */}
                        </section>
