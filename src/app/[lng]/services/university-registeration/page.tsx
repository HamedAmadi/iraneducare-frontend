            ...
            <div className='relative w-full h-fit -z-10 bg-center bg-no-repeat bg-cover bg-[url("../../../public/images/world-map.png")]'>
                ...
                <div className="container">
                    <div className="pt-40 pb-28 text-center text-text">
                        <h1 className="text-5xl mb-5 font-BYekan">{tUR('title')}</h1>
                        <h2 className="text-3xl font-BYekan">{tUR('sub-title')}</h2>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-12 gap-8">
                    ...
                    <div className="col-span-12 lg:col-span-8">
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tUR('enrollment.title')}</h2>
                            <p className="text-lg text-[#335371] mb-4">{tUR('enrollment.desc')}</p>
                            <ul className="text-lg text-[#335371] space-y-4">
                                <li className="mb-4">
                                    <h3 className="text-xl mb-2"><strong className="text-xl mb-8">{tUR('enrollment.step1.title')}</strong></h3>
                                ...
                                <li className="mb-4">
                                    <h3 className="text-xl mb-2"><strong>{tUR('enrollment.step2.title')}</strong></h3>
                                    <ul className="ps-8 list-disc space-y-1">
                                    ...
                                    <div className="my-4">
                                        <h3 className="font-semibold text-xl text-[#335371] mb-1">{tUR('enrollment.step2.translationHelp')}</h3>
                                        <p className="text-lg text-[#335371]">{tUR('enrollment.step2.translationService')}</p>
                                    </div>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-xl mb-2"><strong>{tUR('enrollment.step3.title')}</strong></h3>
                                    <p>{tUR('enrollment.step3.description')}</p>
                                </li>
                                <li className="mb-4">
                                    <h3 className="text-xl mb-2"><strong>{tUR('enrollment.step4.title')}</strong></h3>
                                    <ul className="ps-8 list-disc space-y-1 mb-2">
                                        <li>{tUR('enrollment.step4.point1')}</li>
                                        <li>{tUR('enrollment.step4.point2')}</li>
                                    </ul>
                                    <p className="text-lg text-[#335371]">
                                ...
                                <li className="mb-4">
                                    <h3 className="text-xl mb-2"><strong>{tUR('enrollment.step5.title')}</strong></h3>
                        ...
                        {/* بخش چرا ما؟ */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tUR('whyUs.title')}</h2>
                        ...
                        {/* بخش سوالات متداول */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tUR('faq.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tUR('faq.q1')}</h3>
                                <p className="text-lg text-[#335371]">{tUR('faq.a1-title')}</p>
                                <ul className="ps-8 text-lg text-[#335371] list-disc space-y-1">
                            ...
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tUR('faq.q2')}</h3>
                                <p className="text-lg text-[#335371]">{tUR('faq.a2')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tUR('faq.q3')}</h3>
                                <p className="text-lg text-[#335371]">{tUR('faq.a3')}</p>
                            </div>
                        </section>

                        {/* بخش تماس */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tUR('contact.title')}</h2>
                            <p className="text-lg text-[#335371]">{tUR('contact.description')}</p>
