            ...
            <div className='relative w-full h-fit -z-10 bg-center bg-no-repeat bg-cover bg-[url("../../../public/images/world-map.png")]'>
                ...
                <div className="container">
                    <div className="pt-40 pb-28 text-center text-text">
                        <h1 className="text-5xl mb-5 font-BYekan">{tPLT('title')}</h1>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-12 gap-8">
                    ...
                    <div className="col-span-12 lg:col-span-8">
                        ...
                        <section className="mb-16">
                            <h1 className="text-3xl font-bold text-text mb-6">{tPLT('sub-title')}</h1>
                            <p className="text-lg text-[#335371]">{tPLT('introduction')}</p>
                        </section>

                        {/* لماذا تعلم الفارسية؟ */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tPLT('whyLearn.title')}</h2>
                        ...
                        {/* ميزات الدورة */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tPLT('courseFeatures.title')}</h2>
                        ...
                        {/* الأسئلة الشائعة */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tPLT('faq.title')}</h2>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tPLT('faq.q1')}</h3>
                                <p className="text-lg text-[#335371]">{tPLT('faq.a1')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tPLT('faq.q2')}</h3>
                                <p className="text-lg text-[#335371]">{tPLT('faq.a2')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tPLT('faq.q3')}</h3>
                                <p className="text-lg text-[#335371]">{tPLT('faq.a3')}</p>
                            </div>
                            <div className="mb-2">
                                <h3 className="font-semibold text-xl text-[#335371] mb-1">{tPLT('faq.q4')}</h3>
                                <p className="text-lg text-[#335371]">{tPLT('faq.a4')}</p>
                            </div>
                        </section>

                        {/* حجز الدورة */}
                        <section className="mb-16">
                            <h2 className="text-3xl text-text font-bold mb-6">{tPLT('contact.title')}</h2>
                            <p className="text-lg text-[#335371]">{tPLT('contact.description')}</p>
