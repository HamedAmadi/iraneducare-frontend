        ...
        <>
            <HeroBackground imageSrc="/images/world-map.webp">
                ...
                <div className="xs:container px-4">
                    <h1 className="pt-[clamp(6rem,16vw,10rem)] pb-[clamp(4rem,10vw,7rem)] text-center text-[clamp(1.5rem,4vw,3rem)] text-text font-BYekan">{t('kn-toosi-university-of-technology.title')}</h1>
                </div>
                {/* </div> */}
            </HeroBackground>
            <div className="xs:container py-[clamp(2rem,8vw,6rem)] px-4">
                <div className="relative w-full lg:w-4/5 mx-auto mb-8 md:mb-16">
                    <Image fill sizes="(min-width: 1024px) 80vw, 100vw" priority className='mx-auto rounded-[20px] !relative' src="/images/KNTU/hero.webp" alt={t('kn-toosi-university-of-technology.images-alt.Mechanical-faculty')} />
                </div>
                <section className="mb-8">
                    <h3 className="text-xl md:text-2xl text-text font-bold mb-2">{t('kn-toosi-university-of-technology.university-introduction.title')}</h3>
                    <p className="mb-2 md:text-lg text-[#335371]">{t('kn-toosi-university-of-technology.university-introduction.desc1')}</p>
                    <p className="mb-2 md:text-lg text-[#335371]">{t('kn-toosi-university-of-technology.university-introduction.desc2')}</p>
                    <p className="md:text-lg text-[#335371]">{t('kn-toosi-university-of-technology.university-introduction.desc3')}</p>
                </section>
                <section className="mb-8">
                    <h3 className="text-xl md:text-2xl text-text font-bold mb-2">{t('kn-toosi-university-of-technology.list-of-faculties.title')}</h3>
                ...
                <section className="mb-8">
                    <h3 className="text-xl md:text-2xl text-text font-bold mb-2">{t('kn-toosi-university-of-technology.notable-alumni.title')}</h3>
                    <ul className="ps-8 md:text-lg list-disc text-[#335371]">
                        <li className="mb-1">
                ...
                <section className="mb-8">
                    <h3 className="text-xl md:text-2xl text-text font-bold mb-2">{t('kn-toosi-university-of-technology.welfare-facilities.title')}</h3>
                    <ul className="ps-8 md:text-lg list-disc text-[#335371]">
                        <li className="mb-1">
                ...
                <section className="mb-8">
                    <h3 className="text-xl md:text-2xl text-text font-bold mb-2">{t('kn-toosi-university-of-technology.useful-info-for-students.title')}</h3>
                    <ul className="ps-8 md:text-lg list-disc text-[#335371]">
                        <li className="mb-1">
                ...
                <section className="mb-8">
                    <h3 className="text-xl md:text-2xl text-text font-bold mb-2">{t('kn-toosi-university-of-technology.ranking.title')}</h3>
                    <p className="md:text-lg text-[#335371]">{t('kn-toosi-university-of-technology.ranking.desc')}</p>
                </section>
            </div>
        </>
    );
