        ...
        <>
            <div className='relative w-full h-fit -z-10 bg-center bg-no-repeat bg-cover bg-[url("../../../public/images/world-map.png")]'>
                ...
                <div className="container">
                    <h1 className="pt-40 pb-28 text-center text-text text-5xl font-BYekan">{t('shiraz-university-of-medical-sciences.title')}</h1>
                </div>
            </div>
            <div className="container py-16">
                <div className="relative w-full mb-16">
                    <Image fill className='mx-auto rounded-[20px] !relative' src={ShirazMedUniversityImage} alt='university image' />
                </div>
                <section className="mb-8">
                    <h3 className="text-2xl text-text font-bold mb-2">{t('shiraz-university-of-medical-sciences.university-introduction.title')}</h3>
                    <p className="mb-2 text-lg text-[#335371]">{t('shiraz-university-of-medical-sciences.university-introduction.desc1')}</p>
                    <p className="text-lg text-[#335371]">{t('shiraz-university-of-medical-sciences.university-introduction.desc2')}</p>
                </section>
                <section className="mb-8">
                    <h3 className="text-2xl text-text font-bold mb-2">{t('shiraz-university-of-medical-sciences.list-of-faculties.title')}</h3>
                ...
                <section className="mb-8">
                    <h3 className="text-2xl text-text font-bold mb-2">{t('shiraz-university-of-medical-sciences.notable-alumni.title')}</h3>
                    <ul className="ps-8 text-lg list-disc text-[#335371]">
                        <li className="mb-1">
                ...
                <section className="mb-8">
                    <h3 className="text-2xl text-text font-bold mb-2">{t('shiraz-university-of-medical-sciences.welfare-facilities.title')}</h3>
                    <ul className="ps-8 text-lg list-disc text-[#335371]">
                        <li className="mb-1">
                ...
                <section className="mb-8">
                    <h3 className="text-2xl text-text font-bold mb-2">{t('shiraz-university-of-medical-sciences.useful-info-for-students.title')}</h3>
                    <ul className="ps-8 text-lg list-disc text-[#335371]">
                        <li className="mb-1">
                ...
                <section className="mb-8">
                    <h3 className="text-2xl text-text font-bold mb-2">{t('shiraz-university-of-medical-sciences.ranking.title')}</h3>
                    <p className="text-lg text-[#335371]">{t('shiraz-university-of-medical-sciences.ranking.desc')}</p>
                </section>
            </div>
        </>
    );
