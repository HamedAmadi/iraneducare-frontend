        ...
        <>
            <div className='relative w-full h-fit -z-10 bg-center bg-no-repeat bg-cover bg-[url("../../../public/images/world-map.png")]'>
                ...
                <div className="container">
                    <h1 className="pt-40 pb-28 text-center text-text text-5xl font-BYekan">{t('isfahan-university-of-technology.title')}</h1>
                </div>
            </div>
            <div className="container py-16">
                <div className="relative w-full mb-16">
                    <Image fill className='mx-auto rounded-[20px] !relative' src={IsfahanTechUniversityImage} alt='university image' />
                </div>
                <section className="mb-8">
                    <h3 className="text-2xl text-text font-bold mb-2">{t('isfahan-university-of-technology.university-introduction.title')}</h3>
                    <p className="mb-2 text-lg text-[#335371]">{t('isfahan-university-of-technology.university-introduction.desc1')}</p>
                    <p className="text-lg text-[#335371]">{t('isfahan-university-of-technology.university-introduction.desc2')}</p>
                </section>
                <section className="mb-8">
                    <h3 className="text-2xl text-text font-bold mb-2">{t('isfahan-university-of-technology.key-achievements.title')}</h3>
                ...
                <section className="mb-8">
                    <h3 className="text-2xl text-text font-bold mb-2">{t('isfahan-university-of-technology.vision-and-mission.title')}</h3>
                    <p className="text-lg text-[#335371]">{t('isfahan-university-of-technology.vision-and-mission.desc')}</p>
                </section>
                <section className="mb-8">
                    <h3 className="text-2xl text-text font-bold mb-2">{t('isfahan-university-of-technology.list-of-faculties.title')}</h3>
                    <ul className="ps-8 text-lg list-disc text-[#335371]">
                ...
                <section className="mb-8">
                    <h3 className="text-2xl text-text font-bold mb-2">{t('isfahan-university-of-technology.welfare-facilities.title')}</h3>
                    <ul className="ps-8 text-lg list-disc text-[#335371]">
                        <li className="mb-1">
                ...
                <section className="mb-8">
                    <h3 className="text-2xl text-text font-bold mb-2">{t('isfahan-university-of-technology.useful-info-for-students.title')}</h3>
                    <ul className="ps-8 text-lg list-disc text-[#335371]">
                        <li className="mb-1">
                ...
                <section className="mb-8">
                    <h3 className="text-2xl text-text font-bold mb-2">{t('isfahan-university-of-technology.ranking.title')}</h3>
                    <p className="text-lg text-[#335371]">{t('isfahan-university-of-technology.ranking.desc')}</p>
                </section>
            </div>
        </>
    );
